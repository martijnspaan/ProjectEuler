    ...
    class Part2
    {
        ...
        public static Object Solve()
        {
            foreach (var x in expenseReportValues)
            {
                foreach (var y in expenseReportValues)
                {
                    foreach (var z in expenseReportValues)
                    {
                        if (x + y + z == 2020)
                            return x * y * z;
                    }
